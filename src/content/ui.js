...
export const uiText = {
  en: {
    ...
    mangaReader: {
      ...
      next: "Next page",
      backShort: "Back",
      previousSpread: "Previous page or spread",
      nextSpread: "Next page or spread",
      ...
      hideInterface: "Hide reader interface",
      showInterface: "Show reader interface",
      language: "Language",
      languageActive: (label) => `Language: ${label}`,
      rightToLeft: "Right to left",
      leftToRight: "Left to right",
      verticalReading: "Vertical reading",
      scrollToRead: "Scroll to read",
      swipeRight: "Swipe right for next page",
      pageOrder: (direction) => `${direction} page order`,
      swipeLeft: "Swipe left for next page",
    },
    home: {
      kicker: "Manga artist portfolio / 2026",
      signature: "Drawing stories into life.",
      artworkLabel: "Artwork first",
      artworkNote: "Selected manga, characters and action",
      artworkTitle: "Lines. Motion. Character.",
      recognitionLabel: "Selected recognition",
      recognitionNote: "International manga and illustration competitions",
      experienceLabel: "Experience",
      experienceNote: "Practice and capabilities",
      toolsLabel: "Tools",
      toolsNote: "Digital and traditional",
      sketchbookLabel: "Sketchbook",
      sketchbookTitle: "Recent work.",
      sketchbookDescription: "Recent sketches, studies and manga artwork published on Instagram.",
      sketchbookLoading: "Recent work loading",
      officialResults: (title) => `${title} — Official results (opens in a new tab)`,
      heroAlt: "Color manga illustration by KEVGENGA",
      heroCaption: "Original artwork · KEVGENGA",
